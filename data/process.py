...
@lru_cache(None)
def get_processed_list(dataset_log_file:str, dataset: Literal['train', 'val', 'test'] = None):
    import json
...
def get_processed_len(dataset_log_file, dataset: Literal["train", "val", "test"] = None):
    return len(get_processed_list(dataset_log_file,dataset))


def load_processed_data(dataset_log_file, data_id: int, use_mask: bool = True, dataset: Literal["train", "val", "test"] = None):
